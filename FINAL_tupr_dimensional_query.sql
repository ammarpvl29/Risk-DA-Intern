-- ============================================================================
-- TUPR Dashboard - Dimensional Dataset (Final with Sorting)
-- Author: Ammar Siregar
-- Date: 2025-11-04
-- Purpose: Aggregated TUPR metrics with Product, Risk Grade, Limit Tier dimensions
-- Table: data-prd-adhoc.temp_ammar.tupr_dashboard_final_dataset
-- ============================================================================

CREATE OR REPLACE TABLE `data-prd-adhoc.temp_ammar.tupr_dashboard_final_dataset` AS
...
ORDER BY 1 DESC, 3, 5, 7;  -- Sort: Month DESC, Product, Risk, Limit
