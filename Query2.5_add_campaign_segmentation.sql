  CREATE OR REPLACE TABLE `data-prd-adhoc.temp_ammar.base_loan_offer_with_campaign` AS
  ...
  -- Deduplicate: If customer appears in multiple segments, take highest priority (lowest rnk)
  ...
  -- Join with your existing offer data
  SELECT
    x.*,
